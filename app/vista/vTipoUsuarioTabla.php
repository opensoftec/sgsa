                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="javascript:window.location.reload();" class="active">Tipo Usuario</a> <span class="divider">/</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col col-xs-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="x" placeholder="Buscar Tipo de Usuario">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <div class="btn-group">
                                            <a class="btn btn-success" href="../ajax/tipoUsuarioAjax.php?action=nuevo">
                                ...
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        <?php foreach ($this->dao->listar() as $articulo): ?>
                                            <tr>
                                                <td align="center"><?= $articulo->tpuId ?></td>
                                                <td align="center"><?= $articulo->nombre ?></td>
                                                <td align="center"><?= $articulo->fecharegistro ?></td>
                                                ...
                                                <td align="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a rel="action" data-json='{"action":"editar","id":"<?= $articulo->tpuId ?>"}'>
                                                                    <i class="glyphicon glyphicon-edit"></i> Editar
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a rel="action" data-json='{"action":"eliminar","id":"<?= $articulo->tpuId ?>"}'>
            ...
            $(function () {
                $('#tdatos #tdetalle').on('click', 'a[rel="action"]', function () {
                    ...
                    if(data.action === 'editar'){
                        window.location ='../ajax/tipoUsuarioAjax.php?action=editar&id='+data.id; 
                    }else{
                        $.ajax({
                            url:'../ajax/tipoUsuarioAjax.php',
                            type: 'POST',
                            data : {'id':data.id,'action':data.action},   
                            dataType : 'json'
                        }).done(function (data){
                            if(data.resp){
                               window.location ='wtipoUsuario.php?action=tabla'; 
                            }else{
                                alert(data.error);
                            }
                        });
