...
<!--                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="x" placeholder="Buscar Cliente">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <div class="btn-group">
                                            <a class="btn btn-success" href="../ajax/clienteAjax.php?action=nuevo">
                                ...
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        <?php foreach ($this->dao->listar() as $articulo): ?>
                                            <tr>
                                                <td align="center"><?= $articulo->cliId ?></td>
                                                ...
                                                <td align="center"><span class="label label-primary" title="Activo"><?= (($articulo->big == true) ? "Activo" : "Inactivo") ?></span></td>
                                                ...
                                                <td align="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a rel="action" data-json='{"action":"editar","id":"<?= $articulo->cliId ?>"}'>
                                                                    <i class="glyphicon glyphicon-edit"></i> Editar
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a rel="action" data-json='{"action":"eliminar","id":"<?= $articulo->cliId ?>"}'>
            ...
            $(function () {
                $('#tdatos #tdetalle').on('click', 'a[rel="action"]', function () {
                    ...
                    if (data.action === 'editar') {
                        window.location = '../ajax/clienteAjax.php?action=editar&id=' + data.id;
                    } else {
                        $.ajax({
                            ...
                            if (data.resp) {
                                alert("Eliminado");
                                window.location = 'wcliente.php?action=tabla';
                            } else {
                                alert(data.error);
                            }
                        });
