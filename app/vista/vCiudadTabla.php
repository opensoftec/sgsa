                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="javascript:window.location.reload();" class="active">Ciudad</a> <span class="divider">/</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-12">
...
<!--                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="x" placeholder="Buscar Ciudad">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <div class="btn-group">
                                            <a class="btn btn-success" href="../ajax/ciudadAjax.php?action=nuevo">
                                ...
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        <?php foreach ($this->dao->listar() as $articulo): ?>
                                            <tr>
                                                <td align="center"><?= $articulo->ciuId ?></td>
                                                ...
                                                <!--<td align="center"><span class="label label-danger" title="Inactivo"><?= (($articulo->prvId->estado == true) ? "Activo" : "Inactivo") ?></span></td>-->
                                                <td align="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a rel="action" data-json='{"action":"editar","id":"<?= $articulo->ciuId ?>"}'>
                                                                    <i class="glyphicon glyphicon-edit"></i> Editar
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a rel="action" data-json='{"action":"eliminar","id":"<?= $articulo->ciuId ?>"}'>
            ...
            $(function () {
                $('#tdatos #tdetalle').on('click', 'a[rel="action"]', function () {
                    ...
                    if(data.action === 'editar') {
                        window.location = '../ajax/ciudadAjax.php?action=editar&id=' + data.id;
                    }else{
                        $.ajax({
                            ...
                            if(data.resp) {
                                alert("Eliminado");
                               window.location = 'wciudad.php?action=tabla';
                            }else {
                                alert(data.error);
                            }
                        });
