                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col col-xs-1">
                                        <img src="../../static/img/menu/ciudad5.png" height="65">
                                    </div>
                                    <div class="col col-xs-3">
                                        <h3>Registro de Ciudad</h3>
                                    </div>                                      
                                </div>                     
                            </div>
                                            ...
                                            <form id="frm-ciudad" class="form-horizontal">
                                                <div class="row-fluid">  
                                                    ...
                                                    <div class="item form-group hidden">
                                                        <label class="control-label col-xs-2">ciuId : </label>   
                                                        <div class="col-xs-4">
                                                            <input name="codigo" type="text" class="form-control" value="<?= $this->model->ciuId ?>">
                                                        </div>                  
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-xs-7">
                                                            <input required="required" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,100}" name="nombre" type="text" class="form-control" value="<?= $this->model->nombre ?>" placeholder="Ingrese Nombre">
                                                        </div>                                                        
                                                    </div> 
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-xs-5">
                                                            <select class="form-control id_provincia" name="selectProvincia">
                                                                <?php foreach ($this->dao->listarComboProvincia() as $categoriaPerosonal): ?>
                                                                    <option value="<?= $categoriaPerosonal->prvId ?>"><?= $categoriaPerosonal->nombre ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </div>                                                        
                                                    </div> 
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col col-xs-9 col-xs-offset-2">
                                                            ...
                                                            <button type="reset" onClick="window.location = '../../app/inicio/wciudad.php?action=tabla'" class="btn btn-danger">
                    ...
                    submit: function (event) {
                        ...
                        $.ajax({
                            ...
                            if (data.resp) {
                                ...
                                window.location = '../inicio/wciudad.php?action=tabla';
                            } else {
                                alert(data.error);
                            }
                        });
