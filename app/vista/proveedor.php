                                            ...
                                            <form id="frm-provincia" class="form-horizontal">
                                                ...
                                                <div class="row-fluid">  
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-xs-4">
                                                            <input required="required" name="ruc" type="text" class="form-control" required placeholder="Ingrese el ruc" value="<?= $this->model->ruc ?>" pattern="[0-9]{13}" onkeypress="return controltag(event)">
                                                        </div>                                                        
                                                    </div> 
                                                    <div class="item form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-xs-2">Proveedor Contacto : </label>   
                                                        <div class="col-xs-5">
