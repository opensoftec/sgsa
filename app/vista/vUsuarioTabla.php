...
<!--                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="x" placeholder="Buscar Usuario">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <div class="btn-group">
                                            <a class="btn btn-success" href="../ajax/usuarioAjax.php?action=nuevo">
                                ...
                                <table class="table table-hover table-bordered table-responsive table-striped" id="tdatos">
                                    ...
                                    <tbody id="tdetalle">
                                        <?php foreach ($this->dao->listar() as $articulo): ?>
                                            <tr>
                                                <td align="center"><?= $articulo->usuId ?></td>
                                                <td align="center"><?= $articulo->nombre ?></td>
                                                <td align="center"><?= $articulo->clave ?></td>
                                                <td align="center"><?= (substr($articulo->ultimoingreso,0,10)) ?></td>
                                                ...
                                                <td align="center" class="hidden"><?= $articulo->tpuId->tpuId ?></td>
                                                <td align="center"><?= $articulo->tpuId->nombre ?></td>
                                                <td align="center" class="hidden"><?= $articulo->perId->perId ?></td>
                                                <td align="center"><?= $articulo->perId->nombre ?></td>
                                                <td align="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a rel="action" data-json='{"action":"editar","id":"<?= $articulo->usuId ?>"}'>
                                                                    <i class="glyphicon glyphicon-edit"></i> Editar
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a rel="action" data-json='{"action":"eliminar","id":"<?= $articulo->usuId ?>"}'>
            ...
            $(function () {
                $('#tdatos #tdetalle').on('click', 'a[rel="action"]', function () {
                    ...
                    if (data.action === 'editar') {
                        window.location = '../ajax/usuarioAjax.php?action=editar&id=' + data.id;
                    } else {
                        $.ajax({
                            ...
                            if (data.resp) {
                                alert("Eliminado");
                                window.location = 'wusuario.php?action=tabla';
                            } else {
                                alert(data.error);
                            }
                        });
