    ...
    <body>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col col-xs-6">
                                        <h3>Registro de Categoria Personal</h3>
                                    </div>                                      
                                </div>                     
                                ...
                                <div class="col col-lg-10 col-lg-offset-1">
                                    <div class="panel panel-default panel-primary" style="background: #eee">
                                        ...
                                        <div class="panel-body">                 
                                            <form id="frm-categoriaPersonal" class="form-horizontal">
                                                ...
                                                <div class="row-fluid">
                                                    <div class="form-group">
                                                        <div class="col col-xs-9 col-xs-offset-2">
                                                            ...
                                                            <button type="reset" onClick="window.location = '../../app/inicio/wcategoriaPersonal.php?action=tabla'" class="btn btn-danger">
        ...
        <script>
            $(function () {
                ...
                $('#frm-categoriaPersonal').on({
                    submit: function (event) {
                        event.preventDefault();
                        $.ajax({
                            url: 'categoriaPersonalAjax.php',
                            type: 'POST',
                            data: $(this).serialize(),
                            dataType: 'json'
                        }).done(function (data) {
                            if (data.resp) {
                                ...
                                window.location = '../inicio/wcategoriaPersonal.php?action=tabla';
                            } else {
                                alert(data.error);
                            }
                        });
